...
$(document).ready(function() {
  ...
  $('.requires_further_info_on').click(function() { CoiFormEvent.showFurtherInfo(this); });
  $('.requires_further_info_off').click(function() { CoiFormEvent.hideFurtherInfo(this); });

  // bind click events to the #questions container
  $('#questions').click(function() { CoiFormEvent.continueOnComplete(); });

  // bind keyup events to textareas for entering further info
  $('.further_info').keyup(function() { CoiFormEvent.continueOnComplete(); });

  // check if form is complete onload
  CoiFormEvent.continueOnComplete();
});
